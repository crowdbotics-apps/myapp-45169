"""
Django settings for myapp_45169 project.
...
WSGI_APPLICATION = 'myapp_45169.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_45169 API",
    "DESCRIPTION": "API documentation for myapp_45169 App",
    "VERSION": "v1",
}
